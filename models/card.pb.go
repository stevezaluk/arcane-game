...
type CardObject struct {
	...
	Toughness         int64    `protobuf:"varint,7,opt,name=toughness,proto3" json:"toughness,omitempty"`
...
func (x *CardObject) GetToughness() int64 {
	if x != nil {
		return x.Toughness
	}
	return 0
...
func (x *CardObject) GetPower() int64 {
	if x != nil {
		return x.Power
	}
	return 0
...
var file_card_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x67, 0x68, 0x6e, 0x65, 0x73, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09,
